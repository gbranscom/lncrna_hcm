...
# filter out all genes where all samples have 0-counts
keep <- rowSums(txi.genes.rsem$counts) > 0
txi.genes.rsem$counts    <- txi.genes.rsem$counts[keep, ]
txi.genes.rsem$abundance <- txi.genes.rsem$abundance[keep, ]
txi.genes.rsem$length    <- txi.genes.rsem$length[keep, ]
```
